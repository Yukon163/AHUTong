...
class PreferencesManager @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    val showQRCode: Flow<Boolean> = context.dataStore.data.map {
        prefs->prefs[PreferencesKeys.SHOW_QR_CODE]?:false
    }
    ...
    val isShowAllCourse : Flow<Boolean> = context.dataStore.data.map{
        prefs->prefs[PreferencesKeys.IS_SHOW_ALL_COURSE]?:false
    }
